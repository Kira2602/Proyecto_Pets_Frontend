  ...
  <div class="food-popup">
    <div class="popup-wrapper">
      ...
      <div class="popup-content">
        ...
        <form @submit.prevent="registerFood">
          <div class="form-group">
            <label>Elige una mascota:</label>
            <select
              v-model="foodData.mascota"
          ...
          <button type="submit" class="register-btn">Registrar Comida</button>
        </form>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    validateField(field) {
      this.errors[field] = ''
      if (field === 'mascota' && !this.foodData.mascota) {
        this.errors.mascota = 'Por favor selecciona una mascota'
      }
      if (field === 'descripcion' && this.foodData.descripcion.length < 10) {
        this.errors.descripcion = 'La descripción debe tener al menos 10 caracteres'
      }
      if (field === 'fecha_hora' && !this.foodData.fecha_hora) {
  ...
  mounted() {
    ...
    lottie.loadAnimation({
      ...
      loop: true,
      autoplay: true,
      path: 'https://lottie.host/82e6dd7a-dca0-42bf-b587-84e90dd1233c/lsRBMxjxec.json' // URL de la animación Lottie específica para comida
    })
  }
}
</script>
