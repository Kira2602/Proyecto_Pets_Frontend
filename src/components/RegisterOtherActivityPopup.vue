<template>
  <div class="activity-popup">
    ...
    <NotificationPopup
      ...
      :mascota-id="activityData.mascota"
  ...
  async registerAndOpenNotification() {
    if (this.validateAllFields()) {
      try {
        ...
        if (response.status === 201) {
          console.log("otra actividad registrada:", response.data);
    ...
    notificationData.mascota_id_mascota = this.activityData.mascota; // Mascota seleccionada
